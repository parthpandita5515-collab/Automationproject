...
public class SignupStepdefs {
    ...
    public void userShouldBeAbleToSignupSuccessfuly() {
    ...
    public void useShouldSeeErrorMessageForMandatoryFields() {
        System.out.println("use should see error message for mandatory fields");
    }
    ...
    public void userShouldSeeErrorMessageForInvalidEmail() {
        System.out.println("user should see error message for invalid email");
    }
    ...
    public void userShouldSeePasswordMismatchedMessage() {
        System.out.println("user should see password mismatched message");
    }
    ...
    public void userShouldSeeEmailAlreadyExistEmail() {
        System.out.println("user should see email already exist email");
    }
